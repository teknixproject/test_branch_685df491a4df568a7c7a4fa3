...
export default function LoadingStudent() {
  return (
    ...
    <div mount={true} style={{"display":"block","paddingTop":"10px","paddingRight":"10px","paddingBottom":"10px","paddingLeft":"10px","width":"100%","height":"100%","justifyContent":"center","alignItems":"center","gap":"10px"}}>
      <Skeleton.Avatar active={true} avatar={true} title={true} paragraph={true} style={{"display":"block"}}></Skeleton.Avatar>
      <Skeleton.Image active={true} avatar={true} title={true} paragraph={true} style={{"display":"block"}}></Skeleton.Image>
      <Skeleton.Button active={true} avatar={true} title={true} paragraph={true} style={{"display":"block"}}></Skeleton.Button>
      <Skeleton.Input active={true} avatar={true} title={true} paragraph={true} style={{"display":"block"}}></Skeleton.Input>
